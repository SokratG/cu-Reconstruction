...
__device__ float3 pixel_to_camera(const int3 px_pt, const float4 camera_k, const r32 depth = 1.0);
...
__device__ float3 pixel_to_world(const int3 px_pt, const SE3<r32>& camera_pose_inv, const float4 camera_k, const r32 depth = 1.0);
